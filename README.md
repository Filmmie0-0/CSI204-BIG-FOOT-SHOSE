...
### วัตถุประสงค์
* เพื่อพัฒนาเว็บไซต์อีคอมเมิร์ซสำหรับจำหน่ายรองเท้า
...
## 👥 กลุ่มผู้ใช้งานเป้าหมาย (User Personas)

เพื่อให้ออกแบบระบบได้ตรงตามความต้องการของผู้ใช้งานจริง โครงการได้กำหนด User Persona หลักไว้ดังนี้:

**1. ลูกค้าทั่วไป (Customer)**
* **ตัวอย่าง:** คุณเอ (นักศึกษา/พนักงานออฟฟิศ อายุ 18-35 ปี) ผู้ชื่นชอบแฟชั่นและรองเท้าผ้าใบ
* **เป้าหมาย:** ต้องการค้นหารองเท้าคู่โปรด เช็คไซส์และสีที่มีในสต๊อกได้อย่างรวดเร็ว และสั่งซื้อด้วยขั้นตอนที่ง่ายและปลอดภัย
* **Pain Points:** เคยมีประสบการณ์แย่ๆ กับการสั่งรองเท้าออนไลน์แล้วได้ไซส์ไม่ตรง หรือเว็บไซต์ใช้งานยาก โหลดช้า และติดตามสถานะพัสดุไม่ได้
* **สิ่งที่ระบบตอบโจทย์:** มีระบบค้นหาและฟิลเตอร์ที่ใช้งานง่าย มีรูปภาพและรายละเอียดสินค้าครบถ้วน พร้อมระบบติดตามสถานะคำสั่งซื้อที่ชัดเจน

**2. พนักงานจัดการออเดอร์ (Staff)**
* **ตัวอย่าง:** คุณบี 
* **เป้าหมาย:** ต้องการระบบที่ช่วยจัดการคำสั่งซื้อ ตรวจสอบสลิปการโอนเงิน และอัปเดตสถานะการจัดส่งได้อย่างรวดเร็ว
* **Pain Points:** การตรวจสอบสลิปโอนเงินปลอมหรือข้อมูลไม่ตรงทำได้ยาก และการต้องมานั่งตอบคำถามลูกค้าว่า "ของถึงไหนแล้ว" กินเวลามาก
* **สิ่งที่ระบบตอบโจทย์:** ระบบจัดการหลังบ้านที่สามารถดูรายละเอียดคำสั่งซื้อและตรวจสอบสลิปชำระเงินได้ในหน้าเดียว พร้อมระบบอัปเดตสถานะที่ลูกค้าดูได้เอง

**3. ผู้ดูแลระบบ / เจ้าของร้าน (Admin)**
* **ตัวอย่าง:** คุณซี
* **เป้าหมาย:** ต้องการดูภาพรวมธุรกิจ ยอดขาย จัดการสต๊อกสินค้าหลัก และจัดการสิทธิ์การเข้าถึงของพนักงาน
* **Pain Points:** ขาดเครื่องมือสรุปยอดขายแบบ Real-time ทำให้ตัดสินใจเรื่องโปรโมชันหรือการสต๊อกสินค้าได้ยาก
* **สิ่งที่ระบบตอบโจทย์:** Dashboard สรุปยอดขาย จำนวนคำสั่งซื้อ และระบบจัดการสินค้า ที่ครอบคลุมทั้งหมด

---

## 🔄 กระบวนการพัฒนาซอฟต์แวร์ (SDLC)

โครงการนี้ประยุกต์ใช้ **Software Development Life Cycle (SDLC)** ในรูปแบบ Agile/Iterative เพื่อให้สามารถพัฒนาและปรับปรุงระบบได้อย่างยืดหยุ่น โดยแบ่งออกเป็น 7 ระยะ (Phases) ดังนี้:

1. **Planning (การวางแผน):**
   * กำหนดเป้าหมายและขอบเขตของโปรเจกต์
   * จัดสรรหน้าที่ของสมาชิกในทีมและวางแผนการดำเนินงาน
2. **Requirement Analysis (การวิเคราะห์ความต้องการ):**
...
6. **Deployment (การติดตั้งและส่งมอบ):**
...
| A08 | ดูเรตติ้งและรีวิว | แสดงเรตติ้งและรีวิวตามสินค้านั้นๆ

###  ฟังก์ชันสำหรับ Staff
| รหัส | ฟังก์ชัน (Function) | รายละเอียด | ความสำคัญ |
|---|---|---|---|
| S01 | Login | เข้าสู่ระบบสำหรับผู้ดูแลและพนักงาน 
| S02 | ดูข้อมูล Customer | ตรวจสอบรายชื่อและข้อมูลลูกค้าในระบบ  
| S03 | จัดการสินค้า (CRUD) | เพิ่ม ลบ แก้ไข และอัปเดตข้อมูลสินค้าในแค็ตตาล็อก 
| S04 | จัดการคำสั่งซื้อ | อัปเดตและปรับปรุงสถานะออเดอร์ให้ลูกค้าทราบ 
| S05 | Dashboard | แสดงภาพรวมยอดการสั่งซื้อ รายได้ และจำนวนลูกค้า 
| S06 | ดูเรตติ้งและรีวิว | แสดงเรตติ้งและรีวิวตามสินค้านั้นๆ

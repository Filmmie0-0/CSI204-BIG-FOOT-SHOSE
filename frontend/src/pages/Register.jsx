  ...
  return (
    <div className="min-h-[85vh] flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50/50">
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-3xl border border-gray-200/60 shadow-xl relative overflow-hidden">
        ...
        <div className="absolute -top-20 -left-20 w-40 h-40 bg-purple-500 rounded-full blur-3xl opacity-10 pointer-events-none"></div>
        ...
        <form className="mt-8 space-y-5" onSubmit={submitHandler}>
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 text-red-600 p-4 rounded-xl text-sm font-semibold flex items-center justify-center space-x-2">
        ...
        <div className="mt-8 text-center text-sm border-t border-gray-100 pt-6">
          <p className="text-gray-500 font-medium">
            ...
            <Link to="/login" className="font-bold text-gray-900 hover:text-blue-600 transition-colors underline underline-offset-4">
              Sign In
            </Link>
          </p>
        </div>
